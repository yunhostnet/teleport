...
type remoteSite struct {
	...
	*log.Entry
	...
	// remoteCA is a remote certificate authority as recorded by the client
	// if the certificate authority changes rotation status compared
	// to the last recorded state the reverse tunnel will force reconnect
	// to re-create the client with new settings
