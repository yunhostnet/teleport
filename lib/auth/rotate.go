...
type RotateRequest struct {
	...
	// privateKey is an argument passed in tests,
	// used to speed up the tests by not generating private keys
	privateKey []byte
}
...
type rotationReq struct {
	...
	// privateKey is passed by tests
	// to supply private key for cert authorities
